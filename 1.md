...
[![图1.1 – 社区版和企业版的差别](/homepage/wp-content/uploads/2019050403383533.png)](/homepage/wp-content/uploads/2019050403383533.png)
...
![图1.2 - Odoo实例的登录页面](/homepage/wp-content/uploads/2020122600340337.jpg)
...
![图1.3 – 数据库管理器](/homepage/wp-content/uploads/2020122603182012.jpg)
...
![图1.4 – Master密码警告](/homepage/wp-content/uploads/2020122600380915.jpg)
...
1. 点击Set Master Password按钮。会弹出一个对话框来要求你提供新的主控密码：
   [![设置 Master 密码对话框](/homepage/wp-content/uploads/2019050505371024.jpg)](/homepage/wp-content/uploads/2019050505371024.jpg)图1.5 – 设置新主控密码对话框
...
1. 在数据库管理窗口中，点击页面底部的Create Database按钮。会弹出如下对话框：
   [![创建数据库页面](/homepage/wp-content/uploads/2019050505390961.jpg)](/homepage/wp-content/uploads/2019050505390961.jpg)图1.6 – 新建数据库对话框
...
1. 在数据库管理页面，点击Duplicate Database：
   [![Duplicate Database](/homepage/wp-content/uploads/2019050515123745.jpg)](/homepage/wp-content/uploads/2019050515123745.jpg)图1.7 – 复制数据库对话框
2. 填写表单如下：
...
1. 在数据库管理页面，点击想删除的数据库名称旁的Delete Database链接，会出现下图中的对话框：
   [![Delete Database](/homepage/wp-content/uploads/2019050515230631.jpg)](/homepage/wp-content/uploads/2019050515230631.jpg)图1.8 – 删除数据库弹窗
...
1. 在数据库管理页面，点击想备份数据库名称旁的Backup按钮，会弹出下图这样的对话框：
   [![Backup Database](/homepage/wp-content/uploads/2019050516024419.jpg)](/homepage/wp-content/uploads/2019050516024419.jpg)图1.9 – 备份数据库弹窗
2. 填写表单
...
1. 在数据库管理页面，点击页面底部的Restore Database按钮，会弹出如下的对话框：
   [![Restore Database](/homepage/wp-content/uploads/2019050516123082.jpg)](/homepage/wp-content/uploads/2019050516123082.jpg)图1.10 – 还原数据库对话框
2. 填写表单：
   - Master Password：这是Odoo服务的主控密码。
   - File：这是之前所下载的Odoo备份
...
3. 滚动至页面底部，找到Developer Tools版块
   ![图1.11 – 启用不同开发者模式的链接](/homepage/wp-content/uploads/2020122605474212.jpg)
   图1.11 – 启用不同开发者模式的链接
...
[![Odoo Debug Chrome 插件](/homepage/wp-content/uploads/2019050613255271.jpg)](/homepage/wp-content/uploads/2019050613255271.jpg)
...
2. 点击Update Apps List。
   ![图1.13 – 更新应用列表的菜单项](/homepage/wp-content/uploads/2020122606100382.jpg)
   图1.13 – 更新应用列表的菜单项
3. 在弹出的对话框中点击Update按钮：
   ![图1.14 – 更新应用列表对话框](/homepage/wp-content/uploads/2020122606121927.jpg)
   图1.14 – 更新应用列表对话框
